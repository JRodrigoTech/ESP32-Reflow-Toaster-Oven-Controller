...
String menu(int IP1, int IP2, int IP3, int IP4){
    ...
    String menu  = "<div style=\"overflow:auto\"><div class=\"menu\">"
          ...
          menu  += ">4 : "+ String(profile4)+"</option>"        
                    ...
                    "</select></div>"
                    "<div class=\"menuitem\">Current Temp.: <span id=\"temp\">nan &deg;C</span></div>"
...
static const String bottom = "<div style=\"background-color:#f1f1f1;text-align:center;padding:10px;margin-top:7px;font-size:12px;\"> WiFi Reflow Controller - ESP32 - Version 0.0.1b - <a href=\"https://github.com/JRodrigoTech/ESP32-Reflow-Toaster-Oven-Controller\"  target=\"_blank\">GitHub</a></div>";
